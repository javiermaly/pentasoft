...
<h:form>
		...
		<p>Todas las Tareas que entraron a un Estado en un período de tiempo</p>
		<table>
			<tr>
...
<!-- 			<tr> -->
<%-- 				<td><h:commandButton value="Buscar" action="#{ReportesBean.reporteTareasEntraronEstado}"></h:commandButton></td> --%>
<!-- 			</tr> -->
		</table>
</h:form>
<h:form rendered="#{ReportesBean.estadoId!=null}">
	...
	<center>
			...
			<h:dataTable value="#{ReportesBean.reporteTareasEntraronEstado}"
				var="tarea" border="1">
				<h:column>
					<f:facet name="header">
