...
@NamedQueries(value = { 
		...
		@NamedQuery(name="encSinGrupoMasEncActual",query="SELECT e FROM Encargado AS e WHERE e.cedula NOT IN (SELECT g.enc.cedula FROM Grupo g) OR e.cedula = :cedEncargado")
